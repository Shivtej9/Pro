...
urlpatterns = [
    ...
    path('Hod/View/Attendance',Hod_Views.HOD_VIEW_ATTENDANCE,name='view_attendance'),
    

    # path('Hod/Student/Student_Notification',Hod_Views.STUDENT_SEND_NOTIFICATION,name='student_send_notification'),

    path('Staff/Home',Staff_Views.HOME,name='staff_home'),
    path('Staff/Notifications',Staff_Views.NOTIFICATIONS,name='notifications'),
    path('Staff/mark_as_read/<str:status>',Staff_Views.STAFF_NOTIFICATION_MARK_AS_READ,name='mark_as_read'),
    ...
    path('Student/mark_as_read/<str:status>',Student_Views.STUDENT_NOTIFICATION_MARK_AS_READ,name='student_mark_as_read'),
    ...
    path('Student/View_Results',Student_Views.VIEW_RESULT,name='student_view_result'),
